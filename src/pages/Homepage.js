            ...
            <main className="flex-grow">
                ...
                <section className="bg-white from-blue-50 via-purple-50 to-pink-50 py-20 md:py-32 px-6 md:px-10 lg:px-16 text-center">
                    <div className="container mx-auto">
                        ...
                        {/* Updated for primary */}
                        <p className="text-xl md:text-2xl text-primary font-semibold mb-6">Senior UX Designer</p>
                    ...
                    <div className="container mx-auto">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                            ...
                            <div className="bg-white p-8 rounded-lg text-center">
                                {/* Updated icon color */}
                                <RectangleStackIcon className="h-12 w-12 text-primary mb-4 inline-block" aria-hidden="true" />
                                 {/* Use default text-gray-900 */}
                            ...
                            {/* UI Design Card */}
                             <div className="bg-white p-8 rounded-lg text-center">
                                {/* Updated icon color */}
                                <SwatchIcon className="h-12 w-12 text-primary mb-4 inline-block" aria-hidden="true" />
                            ...
                            {/* UX Design Card */}
                             <div className="bg-white p-8 rounded-lg  text-center">
                                {/* Updated icon color */}
                                <UserGroupIcon className="h-12 w-12 text-primary mb-4 inline-block" aria-hidden="true" />
                            ...
                            {/* Generative AI Card */}
                             <div className="bg-white p-8 rounded-lg text-center">
                                {/* Updated icon color */}
                                <SparklesIcon className="h-12 w-12 text-primary mb-4 inline-block" aria-hidden="true" />
                    ...
                    <div className="container mx-auto text-center">
                        ...
                        <div className="flex flex-wrap justify-center items-center gap-8 md:gap-12">
                            ...
                            <div className="flex items-center space-x-3 p-4 rounded-lg shadow-sm bg-gray-100">
                                {/* Updated secondary */}
                                <PhoneIcon className="h-6 w-6 text-secondary" aria-hidden="true" />
                                {/* Use default text-gray-900 */}
                                <span className="text-lg font-medium text-gray-900">Telecom</span>
                            </div>
                            <div className="flex items-center space-x-3 p-4 rounded-lg shadow-sm bg-gray-100">
                                {/* Updated secondary */}
                                <PaperAirplaneIcon className="h-6 w-6 text-secondary" aria-hidden="true" />
                                <span className="text-lg font-medium text-gray-900">Travel</span>
                            </div>
                            <div className="flex items-center space-x-3 p-4 rounded-lg shadow-sm bg-gray-100">
                                {/* Updated secondary */}
                                <WrenchScrewdriverIcon className="h-6 w-6 text-secondary" aria-hidden="true" />
                ...
                {/* Contact Section */}
                 {/* Updated primary */}
                <section id="contact" className="py-16 md:py-24 px-6 md:px-10 lg:px-16 text-white bg-primary">
                    <div className="container mx-auto text-center">
                        ...
                        <a
                            ...
                            // Updated primary
                            className="bg-white text-primary px-8 py-3 rounded-lg text-lg font-semibold hover:bg-gray-100 transition duration-300 inline-flex items-center"
                        >
